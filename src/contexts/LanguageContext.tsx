...
const translations = {
  en: {
    ...
    'dashboard.subtitle': 'Analyze and optimize your website\'s structured data for better search engine visibility',
    'dashboard.wpAudit.title': 'WordPress Post Schema Audit',
    'dashboard.wpAudit.description': 'Analyze individual WordPress posts for schema optimization opportunities',
    ...
    'schemaAudit.description': 'Analyze and optimize structured data for better SEO performance',
    'schemaAudit.placeholder': 'Enter website URL to audit (e.g., https://example.com)',
    ...
    'wp.passwordHelp': 'Generate an application password in your WordPress admin under Users → Profile',
  ...
  vi: {
    ...
    'dashboard.subtitle': 'Phân tích và tối ưu hóa dữ liệu có cấu trúc của website để có khả năng hiển thị tốt hơn trên công cụ tìm kiếm',
    'dashboard.wpAudit.title': 'Kiểm Tra Schema Bài Viết WordPress',
    'dashboard.wpAudit.description': 'Phân tích từng bài viết WordPress để tìm cơ hội tối ưu hóa schema',
    ...
    'schemaAudit.description': 'Phân tích và tối ưu hóa dữ liệu có cấu trúc để cải thiện hiệu suất SEO',
    'schemaAudit.placeholder': 'Nhập URL website để kiểm tra (ví dụ: https://example.com)',
    ...
    'wp.passwordHelp': 'Tạo mật khẩu ứng dụng trong WordPress admin tại Users → Profile',
